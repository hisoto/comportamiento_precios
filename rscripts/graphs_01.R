...
# NOTA: la gráfica de incidencias (va_anual_inpc_incidencias) vivía aquí. Salió
# a 900_extra_incidencias.R en agosto de 2026: no aparece en el informe mensual,
# así que la corre Master.R pero no Master_informe.R.
